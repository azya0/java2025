...
public class BStringReader {
    ...
    public BStringReader(final byte[] binaryString) throws IllegalArgumentException {
        this(binaryString, (byte) 8);
    }

    public BStringReader(final byte[] binaryString, byte bitsInChar) throws IllegalArgumentException {
